...
export default function Hero() {
  return (
    <div className='flex flex-col lg:flex-row h-250 md:h-300'>
      <div className='md:basis-3/5 bg-black text-white flex flex-col'>
        <div className='mt-32 w-4/6 mx-auto md:mx-0'>
          ...
          <button className='bg-gray-700 w-4/6 md:w-3/5 mb-12 py-3 md:ml-16 font-semibold'>Filialen entdecken</button>
        </div>
      </div>
