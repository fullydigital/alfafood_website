...
export default function MoreAbout() {
  return (
    <div className='flex flex-row h-96 relative z-10 bg-gray-50'>
      ...
      <div className='basis-1/2 flex flex-col my-12'>
        <h3 className='text-3xl font-bold text-left mb-6'>Was wir machen</h3>
        ...
        <button className='bg-red-700 w-4/12 py-3 text-white font-bold text-left px-6'>Erfahre mehr</button>
      </div>
    </div>
  )
}
