...
export default function AboutUsPage() {
  return (
    <>
      ...
      {/* Hero End */}
      {/* About Family start */}
      <div className='flex flex-col-reverse lg:flex-row mt-12 lg:mt-20 mb-20 lg:w-11/12 mx-auto'>
        ...
        <div className='basis-5/6 w-5/6 lg:w-full flex flex-col items-start mx-auto my-auto mb-12 lg:mb-0'>
      ...
      {/* About Family end */}
      {/* divider start */}
      <div className='flex lg:flex-row bg-black text-white mb-20 items-center'>
        <div className='basis-1/3 collapse lg:visible'>
          <img className='h-40 -mt-8 ml-80' src={require('../assets/Alfafood_Tomate.png')} alt="Markentomate" />
        </div>
        <div className='lg:basis-1/3 mx-auto text-3xl md:text-4xl'>
